  ...
  async (userData, thunkAPI) => {
    try {
      const response = await axios.post(
        `${BASE_URL}/rideapi/account/register/`,
        userData,
        {
          headers: {
...
export const resendOTP = createAsyncThunk(
  ...
  async userData => {
    try {
      const response = await axios.post(
        `${BASE_URL}/rideapi/account/resend-otp/`,
        userData,
      );
...
export const forgotPassword = createAsyncThunk(
  ...
  async userData => {
    try {
      const response = await axios.post(
        `${BASE_URL}/rideapi/account/forgot-password/`,
        userData,
      );
...
export const loginUser = createAsyncThunk(
  ...
  async userData => {
    try {
      const response = await axios.post(
        `${BASE_URL}/rideapi/account/login/`,
        userData,
      );
      ...
      console.log(response?.data, refresh, access, 'Login Responses');
...
export const refreshToken = createAsyncThunk(
  ...
  async refreshToken => {
    try {
      const response = await axios.post(
        `${BASE_URL}/rideapi/account/token-refresh/`,
        {
          refreshToken,
        },
      );
...
export const verifyOTP = createAsyncThunk(
  ...
  async (userData, thunkAPI) => {
    try {
      const response = await axios.post(
        `${BASE_URL}/rideapi/account/verify-otp/`,
        {
          otp: userData,
        },
      );
...
export const verifyOTPPassword = createAsyncThunk(
  ...
  async (userData, thunkAPI) => {
    try {
      const response = await axios.post(
        `${BASE_URL}/rideapi/account/password-verify-otp/`,
        {otp: userData},
      );
      console.log(response, 'OTP Verification Response');
      return response.data;
...
export const verifyToken = createAsyncThunk(
  ...
  async userData => {
    try {
      const response = await axios.post(
        `${BASE_URL}/rideapi/account/verify-token/`,
        userData,
      );
...
export const passwordReset = createAsyncThunk(
  ...
  async userData => {
    try {
      const response = await axios.post(
        `${BASE_URL}/rideapi/account/password-reset/`,
        userData,
      );
