  ...
  async (_, {rejectWithValue}) => {
    try {
      ...
      const response = await axios.get(
        `${BASE_URL}/rideapi/delivery/list-all-delivery/`,
        {
          headers: {
...
export const fetchParcelSenders = createAsyncThunk(
  ...
  async (_, {rejectWithValue}) => {
    try {
      ...
      const response = await axios.get(
        `${BASE_URL}/rideapi/delivery/list-parcel-senders/`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  async (payload, {rejectWithValue}) => {
    try {
      ...
      const response = await axios.post(
        `${BASE_URL}/rideapi/delivery/send-parcel/`,
        payload,
        {
          headers: {
            Authorization: `Bearer ${token}`,
...
export const fetchMessaging = createAsyncThunk(
  ...
  async (_, {rejectWithValue}) => {
    try {
      const token = await AsyncStorage.getItem('access_token');
      const response = await axios.get(
        `${BASE_URL}/rideapi/delivery/messaging/`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
...
export const fetchUserDeliveryHistory = createAsyncThunk(
  ...
  async (_, {rejectWithValue}) => {
    try {
      ...
      const response = await axios.get(
        `${BASE_URL}/rideapi/delivery/user-delivery-history/`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
...
export const fetchUserSendParcelHistory = createAsyncThunk(
  ...
  async (_, {rejectWithValue}) => {
    try {
      ...
      const response = await axios.get(
        `${BASE_URL}/rideapi/delivery/user-sendparcel-history/`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
...
export const deliverParcel = createAsyncThunk(
  ...
  async (payload, {rejectWithValue}) => {
    try {
      ...
      const response = await axios.post(
        `${BASE_URL}/rideapi/delivery/deliver-parcel/`,
